...
from .densenet_ecg import DenseNetEcg


class DenseNetEcgModule(L.LightningModule):
    def __init__(
        self,
        num_classes: int,
        ...
        **kwargs,
        ...
        # model
        model_kwargs = inspect.signature(DenseNetEcg).parameters.keys()
        model_kwargs = {k: v for k, v in kwargs.items() if k in model_kwargs}
        self.model = DenseNetEcg(
